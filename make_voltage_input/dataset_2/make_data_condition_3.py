...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 27 16:01:32 2024
...
for temp_file in kept_file_list:
    ...
    for event_type in event_types_list:
        ...
        channel_times_data = mean_per_trials[:,index]
        ...
        for trial_index in range(channel_times_data.shape[0]):
            ...
            one_trial_data = channel_times_data[trial_index,:] ## shape  (51,)
            

        
            for index in range(one_trial_data.shape[0]):
                dict_for_channel_mean[f'time_{index}'].append(one_trial_data[index])
