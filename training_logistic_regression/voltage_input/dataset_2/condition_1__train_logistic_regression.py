...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 27 16:46:10 2024
...
df_data = pd.read_csv('condition_1__data/df_combined_condition_1__mean_channel_mean_time.csv',index_col=0)
...
plt.savefig('condition_1__plots/condition_1_confusion_matrix.pdf', bbox_inches='tight')
# plt.show()
...
with open("condition_1__accuracy.txt", "w") as file:
...
with open('condition_1__stuff_plots/cnf_matrix.pickle', 'wb') as handle:
    pickle.dump(cnf_matrix, handle)


with open('condition_1__stuff_plots/y_pred_proba.pickle', 'wb') as handle:
    pickle.dump(y_pred_proba, handle)


with open('condition_1__stuff_plots/y_test.pickle', 'wb') as handle:
