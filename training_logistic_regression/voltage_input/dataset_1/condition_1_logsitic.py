...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 10:39:48 2024
...
plt.savefig('condition_1__plots/condition_1_confusion_matrix__try4.pdf', bbox_inches='tight')
# plt.show()
...
with open("condition_1__accuracy__try4.txt", "w") as file:
...
with open('condition_1__stuff_plots/cnf_matrix_try4.pickle', 'wb') as handle:
    pickle.dump(cnf_matrix, handle)


with open('condition_1__stuff_plots/y_pred_proba_try4.pickle', 'wb') as handle:
    pickle.dump(y_pred_proba, handle)


with open('condition_1__stuff_plots/y_test_try4.pickle', 'wb') as handle:
