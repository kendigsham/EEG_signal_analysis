...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 11:46:40 2024
...
plt.savefig('condition_1__GFP_plots_restricted_events/condition_1_confusion_matrix__Jasna_GFPinput.pdf', bbox_inches='tight')
# plt.show()
...
plt.legend(loc=4)
plt.title('ROC curve')
plt.savefig('condition_1__GFP_plots_restricted_events/condition_1_ROC_curve__Jasna_GFPinput.pdf', bbox_inches='tight')
# plt.show()
...
with open("condition_1__GFPinput_accuracy_restricted_events.txt", "w") as file:
...
with open('condition_1__GFP_stuffs_plots_restricted_events/cnf_matrix.pickle', 'wb') as handle:
    pickle.dump(cnf_matrix, handle)


with open('condition_1__GFP_stuffs_plots_restricted_events/y_pred_proba.pickle', 'wb') as handle:
    pickle.dump(y_pred_proba, handle)


with open('condition_1__GFP_stuffs_plots_restricted_events/y_test.pickle', 'wb') as handle:
