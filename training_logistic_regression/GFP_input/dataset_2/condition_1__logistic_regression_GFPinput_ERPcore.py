...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  6 16:02:48 2024
...
plt.savefig('condition_1__GFP_plots/condition_1_confusion_matrix_ERPcore_GFPinput.pdf', bbox_inches='tight')
# plt.show()
...
plt.legend(loc=4)
plt.title('ROC curve')
plt.savefig('condition_1__GFP_plots/condition_1_ROC_curve_ERPcore_GFPinput.pdf', bbox_inches='tight')
# plt.show()
...
with open("condition_1__accuracy_ERPcore_GFPinput.txt", "w") as file:
...
with open('condition_1__GFP_stuff_plots/cnf_matrix_ERPcore_GFPinput.pickle', 'wb') as handle:
    pickle.dump(cnf_matrix, handle)


with open('condition_1__GFP_stuff_plots/y_pred_proba_ERPcore_GFPinput.pickle', 'wb') as handle:
    pickle.dump(y_pred_proba, handle)


with open('condition_1__GFP_stuff_plots/y_test_ERPcore_GFPinput.pickle', 'wb') as handle:
