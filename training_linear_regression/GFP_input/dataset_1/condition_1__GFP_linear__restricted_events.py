...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 13:45:55 2024
...
df_data = pd.read_csv(f'{dir_data}/condition_1__GFP_data/df_combined_condition_1__mean_GFP_time.csv',index_col=0)
...
df_result.to_csv('condition_1__GFP_results_restricted_events/df_MSE_N_r_squared.csv')
...
with open('condition_1__GFP_results_restricted_events/linear_model__condition_1.pickle', 'wb') as handle:
