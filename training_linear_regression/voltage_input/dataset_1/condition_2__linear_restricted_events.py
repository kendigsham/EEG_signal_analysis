...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 13:26:30 2024
...
df_data = pd.read_csv(f'{base_data_dir}/condition_2__data/df_combined_condition_2__per_channel_mean_time.csv',index_col=0)

df_data.head()

df_data.shape  ## (59271, 67)
...
# Counter(y_train[:,0].tolist())   ### Counter({0: 22757, 1: 21696})
 
# Counter(y_test[:,0].tolist())   ###Counter({0: 7600, 1: 7218})
...
df_result.to_csv('condition_2__results_restricted_events/df_MSE_N_r_squared.csv')
...
with open('condition_2__results_restricted_events/linear_model__condition_2.pickle', 'wb') as handle:
