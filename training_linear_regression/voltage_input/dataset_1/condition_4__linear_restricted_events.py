...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 13:36:05 2024
...
df_data = pd.read_csv(f'{base_data_dir}/condition_4__data/df_combined_condition_4__all_channel_all_times.csv',index_col=0)
...
df_result.to_csv('condition_4__results_restricted_events/df_MSE_N_r_squared.csv')
...
with open('condition_4__results_restricted_events/linear_model__condition_4.pickle', 'wb') as handle:
