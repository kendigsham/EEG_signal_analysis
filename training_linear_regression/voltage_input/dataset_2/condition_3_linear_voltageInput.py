...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 11 20:22:11 2024
...
df_data = pd.read_csv(f'{dir_base_X}/condition_3__data/df_combined_condition_3__mean_channel_all_times.csv',index_col=0)
...
df_result.to_csv('condition_3__results/ERP_core_df_MSE_N_r_squared.csv')
...
with open('condition_3__results/ERP_core_linear_model__condition_3.pickle', 'wb') as handle:
