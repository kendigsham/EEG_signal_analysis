...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 11 20:24:14 2024
...
df_data = pd.read_csv(f'{dir_base_X}/condition_4__data/df_combined_condition_4__all_channel_all_times.csv',index_col=0)
...
df_result.to_csv('condition_4__results/ERP_core_df_MSE_N_r_squared.csv')
...
with open('condition_4__results/ERP_core_linear_model__condition_4.pickle', 'wb') as handle:
