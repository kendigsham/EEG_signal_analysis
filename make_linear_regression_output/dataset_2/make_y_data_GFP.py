...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  6 14:14:40 2024
...
for temp_file in kept_file_list:
    ...
    for event_type in event_types_list:
        ...
        for trial_index in range(channel_times_data.shape[0]):
            ...
            mean_std_data = np.mean(one_trial_data, axis=0)  ## getting the mean here
...
df_combine.to_csv('df__y_values_reject_subject_N_trial.csv')
